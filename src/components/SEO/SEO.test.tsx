...
test('SEO should render with given title and description, default language', () => {
  ...
  useStaticQuery.mockImplementation(() => ({
    site: {
      siteMetadata: { author, description: siteDescription, title: siteTitle },
    },
  }));
...
test('SEO should render with site description', () => {
  const useStaticQuery = jest.spyOn(Gatsby, 'useStaticQuery');
  useStaticQuery.mockImplementation(() => ({
    site: {
