...
const AboutPage: React.FC<Props> = ({ data }: Props): ReactElement => (
  <Layout>
    <SEO title="About" />
    <H1>About</H1>
    ...
    <Content>
      <p>
        ...
        <em>Software Engineering and Internet Computing</em> from the Technical
      ...
      <p>
        When I was a child I made magazines with friends and sold them to family
        members. When the Internet became a thing I moved my creative endeavors
        into the digital space. I tought myself the required design and
        programming skills and started making websites about stuff I like. After
        some years of freelancing while in school I started my first serious job
        at 2beFOUND in Vienna to build web sites and applications. Nowadays I
        create applications that collect, analyze and move around large amounts
        of data. In April 2016 I joined the startup{' '}
      ...
      <p>
        ...
        I created a number of fun side-
