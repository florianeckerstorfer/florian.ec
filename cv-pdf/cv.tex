...
\section{EXPERIENCE}
\textbf{Senior Frontend Developer} \hfill since August 2018 \\
  mySugr GmbH, Vienna, AT
  \begin{itemize}
    \item Developing web applications with React
    \item Developing web sites with React and Next.js
    \item Software architecture for new and legacy applications
    \item Creating build and deployment tools
    \item Technical planning of new projects
  \end{itemize}
