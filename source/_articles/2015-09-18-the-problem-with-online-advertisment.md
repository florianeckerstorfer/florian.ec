---
title: "The Problem with Online Advertisment"
tags: [ ads, privacy, tracker, advertisment, ad blocker, content blocker ]
slug: the-problem-with-online-advertisment
---
{% block summary %}
On Wednesday Apple released iOS 9 and one of its features is the [WebKit Content Blocker API](https://www.webkit.org/blog/3476/content-blockers-first-look/) which allows developers to create ad and tracker blockers for iOS. Apple did not create an ad blocker themselves, but they gave developers the possiblity to create one and many have done so. I use [Peace](https://geo.itunes.apple.com/us/app/peace-block-ads-trackers-powered/id1031035630?uo=4&at=11lSjE&partnerId=11&mt=8) by [Marco Arment](http://marco.org), but I have also heard good things about [Crystal](https://geo.itunes.apple.com/us/app/crystal-block-ads-browse-faster./id1022177308?uo=4&at=11lSjE&partnerId=11&mt=8). While many people want to use this apps to get rid of ads, I want to reduce the amount of tracking I am exposed to. In this article I am going to explain how you can be tracked on the internet and why it is a problem.
{% endblock %}
